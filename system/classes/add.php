...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validation
    if (empty($ClassName)) $messages['ClassName'] = "Please enter the class name!";
    if (empty($GradeLevel)) $messages['GradeLevel'] = "Please select the grade level!";
    if (empty($subject)) $messages['subject'] = "Please select the subject!";
    if (empty($Teacher_Name)) $messages['Teacher_Name'] = "Please select the teacher!";
    if (empty($start_time)) $messages['start_time'] = "Please enter start time!";
    if (empty($end_time)) $messages['end_time'] = "Please enter end time!";
    if (empty($classdate)) $messages['classdate'] = "Please select the class date!";
    if (empty($month)) $messages['month'] = "Please select the month!";
    if (empty($MaxStudents)) $messages['MaxStudents'] = "Please enter max students!";
    if (empty($classfee)) $messages['classfee'] = "Please enter the class fee!";
    if (empty($hallno)) $messages['hallno'] = "Please enter the hall number!";
    ...
    <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" name="MaxStudents" id="MaxStudents" class="form-control" min="1">
            ...
            <div class="form-group">
                ...
                <input type="text" name="classfee" id="classfee" class="form-control">
